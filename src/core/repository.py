...
def _default_habit_catalog() -> list[dict[str, Any]]:
    ...
    return _normalize_habit_catalog(
        [
            ...
            {"id": "descanso_visual", "kind": "fisico", "min_level": 1},
            {"id": "levantarse_2_min", "kind": "fisico", "min_level": 1},
            ...
            {"id": "revisar_calendario", "kind": "psicologico", "min_level": 1},
            {"id": "elegir_prioridad", "kind": "psicologico", "min_level": 1},
            {"id": "anotar_siguiente_paso", "kind": "psicologico", "min_level": 1},
            {"id": "recoger_5_min", "kind": "psicologico", "min_level": 1},
            {"id": "preparar_manana", "kind": "psicologico", "min_level": 1},
